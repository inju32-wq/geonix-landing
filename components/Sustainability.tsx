          ...
          {t.items.map((item, idx) => {
            ...
            return (
              <div key={idx} className="group p-10 md:p-12 rounded-sm bg-[#F8FAFC] border border-transparent hover:border-zinc-200 transition-all duration-300 flex flex-col items-center shadow-sm">
                <div className="w-14 h-14 bg-white rounded-sm flex items-center justify-center mb-10 shadow-sm text-[#1A1A1A] group-hover:bg-[#FACC15] group-hover:text-white transition-colors">
                  <Icon size={22} />
                </div>

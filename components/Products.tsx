...
export const Products: React.FC = () => {
  ...
  const content = {
    ko: {
      ...
      items: [
        { title: "광물 및 석탄", description: "제철용 점결탄, 발전용 연료탄 및 코크스를\n 취급합니다.", details: { headline: "글로벌 산업의 기반을 닦는 고품질 자원 공급", features: ["Coking Coal, PCI, Met Coke 공급", "러시아, 인도네시아 등 글로벌 소싱 네트워크", "SGS 및 국제 표준(ISO) 품질 관리"], fullDesc: "철강 및 에너지 산업의 필수 원료인 점결탄과 유연탄을 전 세계 고객사에게 안정적으로 전달합니다." } },
        { title: "액화천연가스 (LNG)", description: "북극의 한계를 극복한 친환경 에너지의 미래를\n 제안합니다.", details: { headline: "북극권을 개척하는 에너지 혁신과 독보적 물류", features: ["주요 에너지 허브 기반 공급", "북극항로(NSR) 및 쇄빙 운반선 활용", "저탄소 기반 친환경 에너지 모델"], fullDesc: "글로벌 파트너들과의 협력을 바탕으로 혹독한 환경에서도 중단 없는 에너지 공급을 실현합니다." } },
        { title: "팜오일 글리세린", description: "100% 식물 유래 고순도 프리미엄 원료를\n 공급합니다.", details: { headline: "99.7% 이상의 초고순도 정제 글리세린", features: ["말레이시아산 최상급 팜유 기반", "USP, BP, EP 글로벌 약전 기준 충족", "Halal, Kosher, RSPO 인증 완료"], fullDesc: "투명한 성상과 높은 안정성을 지닌 99.7% 이상의 초고순도 글리세린을 공급합니다." } }
      ]
    },
    en: {
      section: 'Capabilities',
